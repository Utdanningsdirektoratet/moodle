...
$string['languageplugin'] = 'Multilingual Text Plugin';
$string['languageplugin_help'] = 'Enhance accessibility by specifying and tagging the language of individual text sections. Ideal for multilingual content.';
$string['languageplugin_languages'] = 'Enabled Languages for Multilingual Text';
$string['languageplugin_languages_help'] = 'Choose which languages will be available for tagging in your multilingual content.';
$string['level'] = 'Level';
