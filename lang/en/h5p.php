...
$string['languageplugin'] = 'Language plugin';
$string['languageplugin_help'] = 'This plugin allows you to specify the language of different sections within a text, ensuring that each language segment is correctly tagged for accessibility purposes.';
$string['languageplugin_languages'] = 'Language plugin: Enabled languages';
$string['languageplugin_languages_help'] = 'Select the languages you want to enable for the language plugin.';
$string['level'] = 'Level';
